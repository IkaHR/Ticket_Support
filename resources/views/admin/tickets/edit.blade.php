    ...
    <div class="card-body">
        <form action="{{ route("admin.tickets.update", [$ticket->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                ...
                <input type="text" id="title" name="title" class="form-control" value="{{ old('title', isset($ticket) ? $ticket->title : '') }}" readonly>
                @if($errors->has('title'))
            ...
            <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                ...
                <textarea id="content" name="content" class="form-control " readonly>{{ old('content', isset($ticket) ? $ticket->content : '') }}</textarea>
